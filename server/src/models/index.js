...
User.hasMany(Booking, { foreignKey: 'parent_id', as: 'bookings' });
Booking.belongsTo(User, { foreignKey: 'parent_id', as: 'parent' });

// Student <-> Bookings
Student.hasMany(Booking, { foreignKey: 'student_id', as: 'bookings' });
Booking.belongsTo(Student, { foreignKey: 'student_id', as: 'student' });

// Route <-> Bookings
Route.hasMany(Booking, { foreignKey: 'route_id', as: 'bookings' });
...
User.hasMany(Payment, { foreignKey: 'parent_id', as: 'payments' });
