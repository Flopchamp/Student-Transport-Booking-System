...
const { register, login, logout, getMe, updateMe, changePassword, forgotPassword, resetPassword, verifyEmail, resendVerification } = require('../controllers/authController');
...
const authLimiter = rateLimit({
  ...
  max: (process.env.NODE_ENV || 'development') === 'development' ? 2000 : 10,
  message: {
    success: false,
